## Fix "Unable to locate package libjasper-dev"
sudo add-apt-repository "deb http://security.ubuntu.com/ubuntu xenial-security main"

## Dependencies
sudo apt install -y build-essential cmake wget unzip checkinstall pkg-config yasm gfortran \
software-properties-common jasper ffmpeg python3-minimal python3 python3-pip doxygen \
libeigen3-dev libgtk2.0-dev libgtk-3-dev libjpeg8-dev libpng-dev libjasper1 libjasper-dev \
libtiff-dev libavcodec-dev libavformat-dev libswscale-dev libdc1394-22-dev libxine2-dev \
libv4l-dev python-dev python-numpy python3-numpy libtbb2 libtbb-dev libjpeg-dev libxvidcore-dev \
libx264-dev libgtkglext1 libgtkglext1-dev libatlas-base-dev libfaac-dev libmp3lame-dev \
libtheora-dev libvorbis-dev libopencore-amrnb-dev libopencore-amrwb-dev libavresample-dev \
x264 v4l-utils libprotobuf-dev protobuf-compiler libgoogle-glog-dev libgflags-dev \
libgphoto2-dev libhdf5-dev libhdf5-serial-dev gcc-multilib
...
################################################################################
### Test OpenCV C++: Read and Write an image                                 ###
################################################################################
...
## Compile
g++ ./main.cpp -o main -std=c++11 -I/usr/local/opencv-4.4.0/include/opencv4 \
-L/usr/local/opencv-4.4.0/lib -lopencv_imgcodecs -lopencv_core -lopencv_highgui
...
################################################################################
### Test OpenCV Python: Read and Write an image                              ###
################################################################################
